...
{
    private static readonly SymbolIcon ValidIcon = new(SymbolRegular.CheckmarkCircle24)
    ...
    public SettingsPage()
    {
        ...
        InitialScanField.Text =
            CacheObjects.SettingsCache.GetValue(InitialDirectory, "C:/", CacheObjects.StringConverter);
